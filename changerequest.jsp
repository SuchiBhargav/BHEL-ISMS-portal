    ...
    <main class="col-md-9 col-xs-11 p-l-2 p-t-2">
            <a href="#sidebar" data-toggle="collapse"><i class="fa fa-navicon fa-lg"></i></a>
                ...
                <h1><font color="blue">Bharat Heavy Electricals Limited</font></h1>
                       ...
                       <h4 align="right" ><font color="black" >Document No. = <input type="text" name="firstname" value="-" disabled="true"></font></h4>
            </div>
            <div class="container">
  <div id="table" class="table-editable">
<form action="procRequest.jsp" name="thisForm" method="POST">
    <table class="table">
      <tr>
      ...
      <tr>
          <td width="10%"><textarea name="slno" rows="5" cols="10" value="-" disabled="true">-</textarea></td>
          <td width="10%"> <textarea name="curdate" rows="5" cols="10" readonly="true"><%=curdate%></textarea></td>
          <td width="10%"> <textarea name="locndept" rows="5" cols="10"><%=session.getAttribute("loc").toString()%> -- <%=session.getAttribute("dept").toString()%></textarea></td>
        <td width="10%"> <textarea name="nameofperson" rows="5" cols="10"><%=session.getAttribute("name").toString()%></textarea></td>
        <td width="60%"> <textarea name="crtext" rows="10" cols="50"></textarea></td>
