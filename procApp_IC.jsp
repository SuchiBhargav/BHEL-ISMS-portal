...
<div class="container-fluid">
    <div class="row">
		...
		String qry1 = "update CHANGEIMPACT set ISSODONE='1', ISSODATE=TO_CHAR(sysdate, 'dd/MM/yyyy') where CRNO='"+crno+"'";
int execStatus = st.executeUpdate(qry1);
if( 1== execStatus)
out.println("Change Impact Record No.<font color=\"blue\">" + crno +"</font> has been successfully approved by ISSO...");
else
out.println("<font color=\"red\">Error: Change Impact Record could not be approved...</font>");
