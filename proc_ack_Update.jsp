...
<div class="container-fluid">
    <div class="row">
		...
		Statement st=con.createStatement();
                ...
                String qry1;
                qry1 = "update CHANGEIMPLEMENTED set INTIMATIONTOUSER='1', INTIMATIONDATE='"+curdate+"' where CRNO='"+crno+"'";
                
int execStatus = st.executeUpdate(qry1);
if( 1== execStatus){
out.println("Change Implementation No.<font color=\"blue\">" + crno +"</font> has been acknowledged.<br>");
}
else
out.println("<font color=\"red\">Error: Change Implementation could not be acknowledged...</font>");
