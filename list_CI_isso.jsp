...
String query = "select a.CRNO, a.DATEOFCI, b.CRTEXT from CHANGEIMPLEMENTED a, CHANGEREQUEST b where a.STATUS='final' and a.ISSOAPPROVED='0' and a.CRNO not in (select CRNO from CHANGEIMPLEMENTED where status='draft') and a.CRNO=b.CRNO order by TO_NUMBER(a.CRNO)";
...
%>
 <form name="thisForm123" method="POST" action="ack_CI.jsp">
