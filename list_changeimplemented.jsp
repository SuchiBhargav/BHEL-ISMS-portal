...
String query = "select CRNO, DATEOFREQ, CRTEXT from CHANGEREQUEST where STATUS='final' and CIMPFLAG='0' and CRNO not in (select CRNO from CHANGEIMPLEMENTED where status='draft') order by CRNO";
...
%>
 <form name="thisForm123" method="POST" action="changeimplemented.jsp">
