...
<div class="container-fluid">
    <div class="row">
		...
		String crtext="", imparea="", bcp="", recomm="";
		Statement st=con.createStatement();
                String qry = "select a.CRNO, a.DATEOFCIMP, b.CRTEXT, a.IMPACTAREA, a.BCPREQ, a.RECOMMREASON from CHANGEREQUEST b, CHANGEIMPACT a where a.STATUS='final' "+
        "and a.CRNO=b.CRNO and a.CRNO='"+crno +"' order by CRNO";
                ResultSet rs = st.executeQuery(qry);
                
if(rs.next()){
   crtext = rs.getString(3); 
   imparea = rs.getString(4);
   bcp =rs.getString(5); 
   recomm= rs.getString(6);
}
                           %>
<form action="procApp_IC.jsp" method="POST" name="thisForm">
                <h1><font color="blue">Bharat Heavy Electricals Limited</font></h1>
                       <h3 align="center" ><font color="black" >Impact of Change Table Data</font></h3><hr>
  ...
  <div id="table" class="table-editable">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td><textarea name="impactarea" rows="10" cols="20" readonly="true"><%=imparea%></textarea></td>
        <td><textarea name="bcp" rows="10" cols="20" readonly="true"><%=bcp%></textarea></td>
          <td><textarea name="recomm" rows="10" cols="20" readonly="true"><%=recomm%></textarea></td>
