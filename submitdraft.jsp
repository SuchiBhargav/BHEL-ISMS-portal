  ...
  <script language="javascript">
    ...
    background: linear-gradient(to bottom right, blue, white); /* Standard syntax (must be last) */
     ...
     left: auto; 
        ...
        <body>
            <form name="thisForm11" method="POST" action="procSubDraft.jsp">
...
String query = "select CRNO, DATEOFREQ, CRTEXT from CHANGEREQUEST where STATUS='draft' and EMPID='"+
session.getAttribute("empid").toString()+"' order by TO_NUMBER(CRNO)";
