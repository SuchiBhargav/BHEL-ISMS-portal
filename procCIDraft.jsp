...
<div class="container-fluid">
    <div class="row">
		...
		Statement st=con.createStatement();
                String qry = "select a.CRNO, a.DATEOFCI, b.CRTEXT, a.IMPANALYSIS, a.CHANGEAPPROVEDBY, a.ACTUALCHANGES from CHANGEREQUEST b, CHANGEIMPLEMENTED a where a.STATUS='draft' "+
...
if(rs.next()){
   ...
   actualchanges= rs.getString(6);
                           ...
                           %>
<form action="procUpdateCI.jsp" method="POST" name="thisForm">
  ...
  <div id="table" class="table-editable">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td><textarea name="impactanalysis" rows="10" cols="20"><%=impanalysis%></textarea></td>
        <td><textarea name="changeapprovedby" rows="10" cols="20"><%=session.getAttribute("name").toString()%></textarea></td>
          <td><textarea name="actualchanges" rows="10" cols="20"><%=actualchanges%></textarea></td>
