...
<div class="container-fluid">
    <div class="row">
		...
		Statement st=con.createStatement();
                String qry = "select a.CRNO, a.DATEOFCIMP, b.CRTEXT, a.IMPACTAREA, a.BCPREQ, a.RECOMMREASON from CHANGEREQUEST b, CHANGEIMPACT a where a.STATUS='draft' "+
...
if(rs.next()){
   ...
   recomm= rs.getString(6);
                           ...
                           %>
<form action="procUpdateIC.jsp" method="POST" name="thisForm">
  ...
  <div id="table" class="table-editable">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td><textarea name="impactarea" rows="10" cols="20"><%=imparea%></textarea></td>
        <td><textarea name="bcp" rows="10" cols="20"><%=bcp%></textarea></td>
          <td><textarea name="recomm" rows="10" cols="20"><%=recomm%></textarea></td>
