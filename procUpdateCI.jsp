...
<div class="container-fluid">
    <div class="row">
		...
		String qry1 = "update CHANGEIMPLEMENTED set STATUS='"+status+"', DATEOFCI=TO_CHAR(sysdate, 'dd/MM/yyy'), IMPANALYSIS='"+impactanalysis+"', ACTUALCHANGES='"+actualchanges+"' where CRNO='"+crno+"'";
                String qry2;
                
int execStatus = st.executeUpdate(qry1);
if( 1== execStatus){
out.println("Change Implementation No.<font color=\"blue\">" + crno +"</font> has been successfully updated..<br>");
