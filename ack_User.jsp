...
String query = "select a.CRNO, a.DATEOFCI, b.CRTEXT from CHANGEIMPLEMENTED a, CHANGEREQUEST b where a.STATUS='final' and a.ISSOAPPROVED='1' and a.INTIMATIONTOUSER='0' and a.CRNO not in (select CRNO from CHANGEIMPLEMENTED where status='draft') and a.CRNO=b.CRNO order by TO_NUMBER(a.CRNO)";
