...
<div class="container-fluid">
    <div class="row">
        ...
        <button class="btn" align><i class="fa fa-sign-out" aria-hidden="true"></i><a href ="login.jsp"/>Signout</button>
                       <button class="btn" align><i class="fa fa-home"></i><a href ="dashboard2.jsp"/>Dashboard</button>
...
<form action="procIC.jsp" method="POST" name="thisForm">
                <h1><font color="blue">Bharat Heavy Electricals Limited</font></h1>
                       <h3 align="center" ><font color="black" >Format for Impact due to Change</font></h3><hr>
    ...
    <table class="table">
      <tr>
        ...
        <th width="10%">Date</th>
          ...
          <th width="50%">Probable Impact Area</th>
        <th width="50%">Whether change may lead to BCP & System backup is Required</th>
       <th width="50%">Recommended/Not Recommended with reasons</th>
        </tr>
      <tr>
          <td><textarea name="crno" rows="5" cols="10" value="-" readonly="true"><%=crno%></textarea></td>
        ...
        <td><textarea name="impactarea" rows="10" cols="20"></textarea></td>
        <td><textarea name="bcp" rows="10" cols="20"></textarea></td>
          <td><textarea name="recommended" rows="10" cols="20"></textarea></td>
...
<h4 align ="center"><strong>Forwarded to ISSO<br>
    Forwarded to FM Team for Implementation<br>
